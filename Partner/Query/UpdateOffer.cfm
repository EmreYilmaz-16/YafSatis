...
<cfquery name="UPD" datasource="#DSN3#">
    UPDATE PBS_OFFER SET OFFER_CURRENCY=#attributes.OFFER_CURRENCY#,COMPANY_ID=#attributes.company_id#,OFFER_DETAIL='#attributes.OFFER_DESCRIPTION#',FINISHDATE='#FormData.VALID_DATE#',DELIVER_DATE='#FormData.DELIVERY_DATE#',OTHER_MONEY='#FormData.OFFER_MONEY#'
