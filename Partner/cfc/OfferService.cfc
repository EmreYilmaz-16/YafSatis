...
<cfscript>
    MailService.SendMail(MailBody=FORMDATAM.FHtml,FromMail="info@partnerbilgisayar.com",ToMailList="#FORMDATAM.MailTOList#",ToCCMailList="#FORMDATAM.CClist#",ToBCCMailList="#FORMDATAM.BCClist#",fffile="#FNMN#",ffftype="application/pdf",fffcontent="C:/W3/PROD/devcatalyst/MailPdf/#FNMN#.pdf",subject="Deneme Mailidir")
</cfscript>
<!--------
