...
where FOR_OFFER_ID=#arguments.OFFER_ID#
    ...
    <cfloop query="OFFER_HEADER">
        <cfquery name="OFFER_ROWS" datasource="#DSN3#">
            SELECT DISTINCT  S.PRODUCT_NAME,S.PRODUCT_ID,S.STOCK_ID,S.MANUFACT_CODE,S.PRODUCT_CODE,UNIQUE_RELATION_ID,PU.MAIN_UNIT,CONVERT(decimal(18,2),POR.QUANTITY) QUANTITY,ISNULL(TAX,0) TAX,CONVERT(DECIMAL(18,4),POR.PRICE) PRICE,CONVERT(DECIMAL(18,4),POR.PRICE_OTHER) PRICE_OTHER ,POR.OTHER_MONEY 
