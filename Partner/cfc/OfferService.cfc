...
<cfquery name="getOffer" datasource="#dsn3#">
    SELECT C.NICKNAME,C.OZEL_KOD,C.FULLNAME,DELIVERDATE,OFFER_ID,DELIVER_FEE,TAX_STATUS,GENERAL_DISCOUNT_RATE,OTHER_MONEY,OFFER_STAGE,OFFER_DATE,PO.REF_NO,E.EMPLOYEE_NAME,E.EMPLOYEE_SURNAME,PO.DELIVERY_ADDRESS
