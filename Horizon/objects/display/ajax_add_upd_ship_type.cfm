...
<div class="form-group">
    ...
    <input type="text" name="SHIP_TYPE" id="SHIP_TYPE" value="<cfoutput>#ShipTypes.SHIP_TYPE#</cfoutput>" >
    <input type="hidden" name="SHIP_TYPE_ID" id="SHIP_TYPE_ID" value="<cfoutput>#ShipTypes.SHIP_TYPE_ID#</cfoutput>" >
</div>
<div class="form-group">
