<cf_box title="Ürün Özellikleri" scroll="1" collapsable="1" resize="1" popup_box="1">


<cfquery name="getProductProperties" datasource="#dsn1#">
                                select DISTINCT PROPERTY,PROPERTY_DETAIL,ISNULL(PCP.IS_AMOUNT,PDP.IS_EXIT) AS IS_AMOUNT,ISNULL(PCP.PROPERTY_ID,-153) AS FK from 
