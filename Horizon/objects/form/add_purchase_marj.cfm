...
<cfquery name="getMQ" datasource="#dsn3#">
  SELECT FIYAT_ONERME_PBS.ID,FIYAT_ONERME_PBS.WRK_ROW_ID,FIYAT_ONERME_PBS.OFFER_ID,FIYAT_ONERME_PBS.FOR_OFFER_ID,FIYAT_ONERME_PBS.SECEN_EMP,FIYAT_ONERME_PBS.SECEN_DATE,FIYAT_ONERME_PBS.MARJ_EMP,FIYAT_ONERME_PBS.MARJ_DATE,ISNULL(FIYAT_ONERME_PBS.MARJ_ORAN,0)
