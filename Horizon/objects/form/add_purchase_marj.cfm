...
<cfquery name="getMQ" datasource="#dsn3#">
  ...
  ,PBS_OFFER_ROW.PRICE_OTHER,PBS_OFFER_ROW.OTHER_MONEY,PBS_OFFER_ROW.QUANTITY,PBS_OFFER_ROW.DISCOUNT_COST
    ...
    ,PBS_OFFER.DELIVER_FEE
    ,PBS_OFFER.TAX_STATUS
    ,PBS_OFFER_ROW.DELIVER_DATE
    ,PBS_OFFER.GENERAL_DISCOUNT_RATE
    ,PBS_OFFER.OFFER_CONDITION
    ,PBS_OFFER.VALID_DAYS
    ,PBS_OFFER.DELIVERY_COST
    ,PBS_OFFER.PACKAGE_FEE
    ,PBS_OFFER.PAYMENT_TERMS
