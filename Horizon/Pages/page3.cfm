...
<cfquery name="GETrOWS" datasource="#DSN3#">
    SELECT POR.*,ISNULL(PURCHASE_PRICE,0) AS PPRC,ISNULL(PURCHASE_MONEY,'TL') AS PPRM,'' AS FIRST_REMARK,
    ...
    WHERE OFFER_ID=#attributes.OFFER_ID# ORDER BY  SEPEREATOR_SIRA
</cfquery>
...
<cf_box>
    <cf_box_elements>
        <!--- 1. Grid <cfif listFind(session.ep.USER_LEVEL,"12")><cfelse>style="display:none"</cfif>  --->
        <div class="col col-12 col-sm-12 col-md-12 col-lg-12 col-xs-12 margin-bottom-5 border-bottom border-grey" >
            ...
            <div class="col col-3 col-sm-3 col-md-3 col-lg-3 col-xs-12">
                <div class="form-group col col-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="margin-right-5 paddingNone margin-0">
                        <a id="BUTON_6" href="javascript://" onclick='openBoxDraggable("index.cfm?fuseaction=objects.emptypopup_hrz_pbs_smartTools&ListType=add_purchase_price_marj&OFFER_ID=<cfoutput>#Offer.OFFER_ID#</cfoutput>");' class="ui-wrk-btn ui-wrk-btn-success ui-wrk-btn-addon-left "><i class="fa fa-money"></i><span class="font-xs">Fiyat Giriş</span></a>
                    </div>
                    <div class="margin-right-5 paddingNone margin-0">
                    ...
                    <div class="margin-right-5 paddingNone margin-0">
                        <a id="BUTON_2" href="javascript://" onclick="windowopen('index.cfm?fuseaction=sales.emptypopup_update_inquiry&OFFER_ID=<cfoutput>#Offer.OFFER_ID#&OFC_COUNT=#GETrOWS.recordCount#</cfoutput>','wide')" class="ui-wrk-btn ui-wrk-btn-warning ui-wrk-btn-addon-left"><i class="fa fa-edit"></i>EDIT</a>
                    </div>
                    <div class="margin-right-5 paddingNone margin-0">
         ...
         <!--- 2. Grid <cfif listFind(session.ep.USER_LEVEL,"12")><cfelse>style="display:none"</cfif> --->
        <div class="col col-12 col-sm-12 col-md-12 col-lg-12 col-xs-12 margin-bottom-5 border-bottom border-grey" >
            <!--- 1. Clumn --->
            <div class="col col-2 col-sm-2 col-md-2 col-lg-2 col-xs-12">
                <div class="form-group col col-12 col-md-12 col-sm-12 col-xs-12">
...
<div id="SubTotalArea">
    <cf_grid_list>
        <thead>
            <tr>
                <th colspan="<cfif SatisSettings.IS_SHOW_TL eq 1>3<cfelse>2</cfif>">
                    Toplamlar
                </th>
            </tr>
        </thead>
