...
<a onclick="openBoxDraggable('index.cfm?fuseaction=objects.emptypopup_add_ship_machine&ShipId=<cfoutput>#attributes.ShipId#</cfoutput>')" class="ui-wrk-btn ui-wrk-btn-warning ui-wrk-btn-addon-left"><span class="icn-md icon-settings"></span>Add Machine</a>
</cf_box>
<!----
