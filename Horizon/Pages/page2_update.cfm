            ...
            <div class="form-group col col-3 col-md-3 col-sm-3 col-xs-12" id="dpAddress" >
                <div class="col col-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="paymethod" placeholder="Pay Method" id="paymethod" value="<cfoutput>#OFFER_DATA.PAYMETHOD#</cfoutput>">
        ...
        <div class="margin-top-10 col col-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group col col-3 col-md-3 col-sm-3 col-xs-12">
                <div class="col col-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <input type="hidden" name="selected_money" id="selected_money" value="<cfoutput>#OFFER_DATA.OTHER_MONEY#</cfoutput>">
                </div>
            </div>
