...
<div style="display:flex">
    <cfif isDefined("attributes.is_sale") and attributes.is_sale eq 1>
        <button onclick="window.location.href='/index.cfm?fuseaction=<cfoutput>#attributes.fuseaction#&offer_id=#attributes.offer_id#</cfoutput>&is_sub=1&ppp=pdf1'"class="ui-wrk-btn ui-wrk-btn-success">Müşteri Teklifi</button> 
    ...
    <cfelse>
        <button onclick="window.location.href='/index.cfm?fuseaction=<cfoutput>#attributes.fuseaction#&offer_id=#attributes.offer_id#</cfoutput>&is_sale=0&is_sub=1&ppp=pdf2'" class="ui-wrk-btn ui-wrk-btn-success">İkmalci Fiyat Talebi</button> 
