...
<div class="page-div">
    ...
    ,POR2.IS_VIRTUAL
    ,POR2.WRK_ROW_ID
	,CASE WHEN POR2.IS_VIRTUAL = 1 THEN VP.PART_NUMBER ELSE S.MANUFACT_CODE END AS MN_CODE
...
WHERE POR1.OFFER_ID=#attributes.OFFER_ID#  ORDER BY POR2.SEPERATOR_SIRASI,POR2.PROP_LIST
        </cfquery>
    ...
    <b>#getpp.PROPERTY#</b>:#PROPERTY_DETAIL#
        ...
        <div class="total-div">
            <div class="total-div-left">
                <h3 class="total-title">THANK YOU FOR YOUR ORDER !</h3>
        ...
        <div class="foot-text-div">
            <p class="foot-text">
                ACCORDING TO SOLAS CHAPTER II-1 PART A-1 REGULATION 3-5,WE HEREBY DECLARETHATTHESUPPLIED PARTS DO NOT
                CONTAIN ASBESTOSMATERIAL. ASBESTOS-FREE
                CERTIFICATES, IF AVAILABLE, CAN BE PROVIDED BASEDON REQUEST.
            </p>
        </div>
    </div>
