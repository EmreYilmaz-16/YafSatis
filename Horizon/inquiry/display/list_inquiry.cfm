...
<cf_box>
        <div style="display:flex;flex-direction: column;height:100vh">
            ...
            <button onclick='openBoxDraggable("index.cfm?fuseaction=sales.emptypopup_list_virtual_products")' style="font-size: 14pt;padding: 20px;width: 100%;border: solid 1px #cbbf22;border-radius: 10px;background: #fff02aa8;font-weight: bold;color: white;margin: 5px;">List Waiting Virtual Products </button>
            <hr>
